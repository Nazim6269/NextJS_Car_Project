...
const Footer = () => {
  return (
    <footer className="flex flex-col text-black-100 mt-5 border-t border-grey-100">
      <div className="flex max-md:flex-col flex-wrap justify-between gap-5 sm:px-16 px-6 py-1-0">
      ...
      <div className="flex justify-between items-center flex-wrap border-t border-gray-100 sm:px-16 px-6 py-10">
        <p>@2024 CarMart. All Rights Reserved by NazimUddin</p>
        <div className="footer__ copyrights-link">
